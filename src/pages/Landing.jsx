...
// import { FaCar, FaMoneyBillAlt, FaLeaf, FaUser } from 'react-icons/fa';
...
//             <img src="https://th.bing.com/th/id/OIP.HQrq0z6AIwPMcJgFCWRdoQHaHa?rs=1&pid=ImgDetMain" alt="CarPool Logo" className="h-8" />
//           </div>
...
//                   <a href="#admin" className="block px-4 py-2 hover:bg-gray-100">Admin Login</a>
//                 </div>
//               )}
//             </div>
//           </div>
//         </nav>
//         <div className="bg-cover bg-center h-screen flex items-center justify-center" style={{ backgroundImage: "url('https://www.newcastle.edu.au/__data/assets/image/0008/869849/Transport-Website-Rideshare-Wide-Feature-800x765px.jpg')" }}>
//           <div className="text-center">
//             <h2 className="text-4xl md:text-5xl font-bold mb-4">Join the Carpool Revolution</h2>
//             <p className="text-lg mb-6">Save money, reduce traffic, and help the environment by sharing your ride with others.</p>
//             <a href="#signup" className="bg-blue-500 text-white px-6 py-3 rounded-full text-lg font-semibold hover:bg-blue-600">Get Started</a>
//           </div>
//         </div>
//       </header>
...
//           {/* Logo */}
//           <div className="flex items-center">
//             <img src="https://th.bing.com/th/id/OIP.HQrq0z6AIwPMcJgFCWRdoQHaHa?rs=1&pid=ImgDetMain" alt="CarPool Logo" className="h-12" />
//           </div>
...
//                     className={`block px-4 py-2 ${activeLink === 'admin' ? 'bg-gray-100' : 'hover:bg-gray-100'}`}
//                   >
//                     Admin Login
//                   </a>
//                 </div>
