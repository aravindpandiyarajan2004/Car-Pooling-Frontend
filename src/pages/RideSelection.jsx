...
// // //         <h1 className="text-center text-2xl font-bold mb-6">Ride Selection</h1>
...
// // //             <h3 className="text-xl font-bold mt-6">Vehicle Information</h3>
...
// //       } else {
// //         Swal.fire('Error', 'Failed to confirm booking. Please try again later.', 'error');
// //       }
// //     } catch (error) {
...
//           </div>
//         ) : (
//           <p>No Schedules is available now..Loading...</p>
